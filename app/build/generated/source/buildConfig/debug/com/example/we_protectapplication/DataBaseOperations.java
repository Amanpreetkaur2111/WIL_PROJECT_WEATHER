...
public class DataBaseOperations extends SQLiteOpenHelper {
    ...
    public static final String C_NAME = "card_name";
...
//this is the query for creating Profile database
    public String PROFILE_QUERY = "CREATE TABLE " + PROFILE_TABLE + "(" + FIRST_NAME + " TEXT," + IMAGE_NAME + " TEXT," + LAST_NAME + " TEXT);";

//this is the query for creating Payment database
    public String PAYMENT_QUERY = "CREATE TABLE " + PAYMENT_TABLE + "(" + C_NAME + " TEXT," + C_NUMBER + " TEXT," + CVV + " TEXT," + EXP_DATE + " TEXT);";
...
//this method is setting profile information into table
    public void putProfile(DataBaseOperations dop, String fName, String lName, String imageName){
...
//this method is setting payment information into table
    ...
    public void putPayment(DataBaseOperations dop, String cardName ,String cardNumber, String cvv, String expDate){
        SQLiteDatabase sqLiteDatabase = dop.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(C_NAME,cardName);
...
//this method retrieve  the profile information saved into database
    public Cursor getProfileInformation(DataBaseOperations dop) {
        ...
        String[] coloumns = {FIRST_NAME, LAST_NAME,IMAGE_NAME};
...
//this method retrieve  the payment information saved into database
    public Cursor getPaymentInformation(DataBaseOperations dop) {
        SQLiteDatabase SQ = dop.getReadableDatabase();
        String[] coloumns = {C_NAME, C_NUMBER, CVV,EXP_DATE,};
